...
- `kill` sends SIGTERM and allows graceful shutdown.
...
It displays real-time process and system resource information.
...
It starts a process with a specific scheduling priority.